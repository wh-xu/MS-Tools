...
public class SpectraClusterStandalone {
	...
	double elapsed_time = (double) (end_time - start_time) / 1000000000.00001;
	System.out.println("Load and preprocessing MGF file elapsed: " + elapsed_time);
	

	start_time = System.nanoTime();
        clusterBinaryFiles(binaryFiles, clusteringThresholds, resultFile);
	end_time = System.nanoTime();
	elapsed_time = (double) (end_time - start_time) / 1000000000.00001;
	System.out.println("Clustering elapsed: " + elapsed_time);
    ...
    public void clusterExistingBinaryFiles(File clusteringDirectory, List<Float> clusteringThresholds, File resultFile)
        ...
        // TODO: figure out a better method to check this
